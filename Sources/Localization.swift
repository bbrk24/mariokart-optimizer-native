...
let localizations: [Locale: Localization] = [
    Locale(identifier: "en_US"): Localization(
        ...
        uiElements: .init(
            ...
            saveFailedError: "Could not write to file %@"
        ),
        kartParts: [
            "Mario": "Mario",
            "Ludwig": "Ludwig",
    ...
    Locale(identifier: "ja"): Localization(
        stats: .init(
            landSpeed: "Ground speed",
            waterSpeed: "Water speed",
            airSpeed: "Glider speed",
        ...
        kartParts: [
            ...
            "TanookiMario": "タヌキマリオ",
            "InklingBoy": "ボーイ",
            "VillagerBoy": "むらびと（ボーイ）",
            "CatPeach": "ネコピーチ",
            "InklingGirl": "ガール",
            "VillagerGirl": "むらびと（ガール）",
            "DiddyKong": "Diddy Kong",
            "Toad": "キノピオ",
            "ShyGuy": "ヘイホー",
            "Larry": "ラリー",
            ...
            "BabyPeach": "ベビィピーチ",
            "BabyDaisy": "ベビィデイジー",
            "BabyRosalina": "ベビィロゼッタ",
            "Lemmy": "レミー",
            "MetalMario": "メタルマリオ",
            "PinkGoldPeach": "ピンクゴールドピーチ",
            "Wiggler": "Wiggler",
            "Waluigi": "ワルイージ",
            "DonkeyKong": "ドンキーコング",
            "Roy": "ロイ",
